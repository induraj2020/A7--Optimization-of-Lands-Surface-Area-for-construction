...
Nb_Indiv_LST = [20]      # [5, 7, 10, 15, 20]  
psi_LST = [0.2]          # [0.2, 0.4, 0.5, 0.7, 0.8]
c1_LST = [1.0]           # [0.2, 0.8, 1.0, 1.5, 2.0]
c2_LST = [2.0]           # [0.2, 0.8, 1.0, 1.5, 2.0]

numTests = 30            # Number of test to Statistics Analysis.

polygone_LST = []
polygone_LST.append( ( ((10,10),(10,400),(400,400),(400,10)) , 152100) )  #Polygon 1.
polygone_LST.append( ( ((10,10),(10,300),(250,300),(350,130),(200,10)) , 81100) )  #Polygon 2.
polygone_LST.append( ( ((50,150),(200,50),(350,150),(350,300),(250,300),(200,250),(150,350),(100,250),(100,200)) , 52500) )
polygone_LST.append( ( ((50,50),(50,400),(220,310),(220,170),(330,170),(330,480),(450,480),(450,50)) , 116650) )

# ( polygone, maxPolArea ) = ( ((10,10),(10,400),(400,400),(400,10)) , 152100)
# ( polygone, maxPolArea )= ( ((10,10),(10,300),(250,300),(350,130),(200,10)) , 81100) 
# ( polygone, maxPolArea ) =( ((50,150),(200,50),(350,150),(350,300),(250,300),(200,250),(150,350),(100,250),(100,200)) , 52500) 
# ( polygone, maxPolArea ) =( ((50,50),(50,400),(220,310),(220,170),(330,170),(330,480),(450,480),(450,50)) , 116650)
...
def drawStats(Htemps, Hbest, parametersSTR, titleName):
    ...
    plt.subplot(1,1,1)
    # plt.semilogx(Htemps, Hbest, label=parametersSTR)
...
def drawTimeVS(Nb_Cycles_LST, HComputationTime, titleName):
    fig4 = plt.figure(4,figsize=(9,6))
    plt.subplot(1,1,1)
    # plt.semilogx(Htemps, Hbest, label=parametersSTR)
    plt.plot(Nb_Cycles_LST, HComputationTime)   #plt.semilogy
    plt.title(titleName)
    plt.xlabel('Iterations')
...
def main_PSO(Nb_Cycles, Nb_Indiv, psi, c1, c2 ):
    ...
    # titleName = ' NbPar: ' + str(Nb_Indiv) + ' PSI: ' + str(psi) + ' C1: ' + str(c1) + ' C2: ' + str(c2)
    # # parameterName =  + ' Average BestArea:' + str( round((aire(poly2list(post2rect(best_of_best[0]["bestpos"]))[:-1])/maxPolArea)*100,1) )  + "%"
    # parameterName =  ' Nb_Cycles: ' + str(Nb_Cycles)
...
HComputationTime = []
BoxPlotData = []
for (polygone, maxPolArea ) in polygone_LST:    
...
titleName = 'NbTest:' + str(numTests) + 'NbCycles:' + str(Nb_Cycles) +' PSI: ' + str(psi) + ' C1: ' + str(c1) + ' C2: ' + str(c2) 
# drawTimeVS(Nb_Cycles_LST, HComputationTime, titleName)
print(BoxPlotData)
