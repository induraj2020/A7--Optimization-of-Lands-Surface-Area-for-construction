...
c2_LST = [0.2, 0.8, 1.0, 1.5, 2.0] #[0.2]           # [0.2, 0.8, 1.0, 1.5, 2.0]

numTests = 30            # Number of test to Statistics Analysis.

( polygone, maxPolArea ) = ( ((10,10),(10,400),(400,400),(400,10)) , 152100)
# ( polygone, maxPolArea )= ( ((10,10),(10,300),(250,300),(350,130),(200,10)) , 100) 
# ( polygone, maxPolArea ) =( ((50,150),(200,50),(350,150),(350,300),(250,300),(200,250),(150,350),(100,250),(100,200)) , 50000) 
# ( polygone, maxPolArea ) =( ((50,50),(50,400),(220,310),(220,170),(330,170),(330,480),(450,480),(450,50)) , 52000)
...
titleName = 'NbTest:' + str(numTests) + ' NbPar: ' + str(Nb_Indiv) + ' PSI: ' + str(psi) + ' C1: ' + str(c1) 
drawBoxPlot(BoxPlotData, c2_LST, 'C2', titleName)
print(BoxPlotData)
