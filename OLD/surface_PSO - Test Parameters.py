...
## PARAMETERS:
Nb_Cycles_LST = [500, 1000, 1500, 5000, 10000, 20000] #[10000]  # [500, 1000, 1500, 5000, 10000, 20000]
Nb_Indiv_LST = [20] #[5]       # [5, 7, 10, 15, 20]  
...
titleName = 'NbTest:' + str(numTests) + ' PSI: ' + str(psi) + ' C1: ' + str(c1) + ' C2: ' + str(c2) 
