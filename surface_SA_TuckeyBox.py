...
IterMax = 10000 # 15000 max number of iterations of the algorithm

sizeNeigh = 1 # Size of the Xmax-Xmin to randomize
anglemin = 30
anglemax = 150

nb_tests = 30 #Number of test

# ***************** Paramètres du problème ******************
polygone_LST = []
polygone_LST.append( ( ((10,10),(10,400),(400,400),(400,10)) , 152100) )  #Polygon 1.
polygone_LST.append( ( ((10,10),(10,300),(250,300),(350,130),(200,10)) , 60000) )  #Polygon 2.
polygone_LST.append( ( ((50,150),(200,50),(350,150),(350,300),(250,300),(200,250),(150,350),(100,250),(100,200)) , 27400) )
polygone_LST.append( ( ((50,50),(50,400),(220,310),(220,170),(330,170),(330,480),(450,480),(450,50)) , 51600) )

polygone_LST = []
polygone_LST.append( ( ((10,10),(10,400),(400,400),(400,10)) , 152100, 152100) )  #Polygon 1.
polygone_LST.append( ( ((10,10),(10,300),(250,300),(350,130),(200,10)) , 81100, 60000) )  #Polygon 2.
polygone_LST.append( ( ((50,150),(200,50),(350,150),(350,300),(250,300),(200,250),(150,350),(100,250),(100,200)) , 52500, 27400 ) )
polygone_LST.append( ( ((50,50),(50,400),(220,310),(220,170),(330,170),(330,480),(450,480),(450,50)) , 116650, 51600 ) )
...
def randomNeighbor(rectSol, polygone, pointVar):
    ...
    while not boolOK: # tant que non faisable
        iii+=1
        if pointVar=='O':
            xo = rectSol['pos'][2] + random.uniform(-xSN,xSN)
            yo = rectSol['pos'][3] + random.uniform(-ySN,ySN)            
        ...
        if pointVar=='A':
            ...
            # xo=xa+pow(-1,random.randint(0,1))*random.uniform(10,min(xa-xmin,xmax-xa))
            # yo=ya+pow(-1,random.randint(0,1))*random.uniform(10,min(ya-ymin,ymax-ya))
...
global xmin,xmax,ymin,ymax, maxArea, best

lstVar=['A','Angle','O']

global polygone, maxPolArea
BoxPlotData = []
for (polygone, maxPolArea, maxPolArea2 ) in polygone_LST:  
    HLastBest =[]
    HAvgBest = []
    for i in range(nb_tests):
        ...
        for i in range(IterMax):
            ...
            for pointVar in lstVar:
                ...
                while (iterStep > 0): 
                    ...
                    # neighbor = randomNeighbor(best, polygone, pointVar)
        ...
        dispRes(best['pos'], best['eval'], num_improvements)
        # graphic of stats
        # dessine(polygonefig, poly2list(pos2rect(best['pos'])))
        # drawStats(Htime, Henergy, Hbest, HT, parametersName)

        HLastBest.append(best['eval'])
        # HAvgBest.append( round(best['eval']/maxPolArea*100,1) )
        # HAvgBest.append( best['eval'] )
        if best['eval'] > maxPolArea2:
            HAvgBest.append( round(maxPolArea2/maxPolArea*100,1) )
        else:
            HAvgBest.append( round(best['eval']/maxPolArea*100,1) )

    print(  'AREA MIN: ' + str(round(min(HLastBest))) + 
            ' MAX: ' + str(round(max(HLastBest))) + 
            ' MEAN: ' + str(round(sum(HLastBest)/len(HLastBest))) +
            ' STD: ' +  str(round(st.stdev(HLastBest))))
    # drawBoxPlot(HLastBest, 'Nb_Tests: ' + str(nb_tests) )
    BoxPlotData.append( HAvgBest )

print(BoxPlotData)
titleName='Tests: 30 IterMax= 10000 Step: 7 Alpha: 0.9 '
polygon_NAME_LST=['Polygon-1','Polygon-2','Polygon-3','Polygon-4']
drawBoxPlot(BoxPlotData, polygon_NAME_LST, 'Polygon', titleName)
plt.show()
